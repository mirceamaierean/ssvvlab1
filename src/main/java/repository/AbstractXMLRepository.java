...
public abstract class AbstractXMLRepository<ID, E extends HasID<ID>> extends AbstractCrudRepository<ID, E>
        implements FileRepository<ID, E> {
     ...
     * @return null daca obiectul s-a salvat cu succes sau obiectul daca acesta
     *         exista deja in memorie
     */
    @Override
     ...
     * @return null daca obiectul a fost modificat sau obiectul, daca acesta nu
     *         exista
     */
    @Override
